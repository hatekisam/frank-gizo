                        ...
                        <div className="flex  h-[89%]">
                                <div className="w-[24%] border-r-2 border-r-[#0000DA] h-full">
                                        ...
                                        <div className='p-2'>
                                                {chats.map((chat) => {
                                                        return (
                                                                <Link to={`/messages/${chat.id}`} key={chat.id} className='my-1  text-sm'>
                                                                        <div className="flex gap-2 items-center hover:bg-[#F8F8F8] px-2 py-1">
                                                                                <img src={chat.image} alt={chat.description} className='w-[15%]' />
                                                                                <p>{chat.members.length > 2 ? chat.name : chat.members.filter(member => member !== me)}</p>
                                                                        </div>
                                                                </Link>
                                                        )
                                                })}
